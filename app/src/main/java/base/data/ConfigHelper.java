...
import base.data.entity.ConfigInfo;
...
public class ConfigHelper extends DbUtilsXutils3<ConfigInfo> {
    ...
    public static void initConfigInfo() {
        ...
        configInfo.setServerUrl("www.mg0607.cn");//qukoubei.59156.cn
        ...
        configInfo1.setServerUrl("192.168.0.106");
        configInfo1.setServerPort(809);
